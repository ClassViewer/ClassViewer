...
public abstract class OldFileTree implements Comparable<OldFileTree> {
    ...
    OldFileTree(FileType type, FilePath path) {
        this.type = type;
        this.path = path;
    }
    ...
    public Set<OldFileTree> getChildren() {
        return children;
    }
    ...
    @Override
    public int compareTo(OldFileTree other) {
    ...
    public static final class RootNode extends OldFileTree {
    ...
    public static final class FileNode extends OldFileTree {
